...
- 新增附件发送与接收：支持图片、视频和其他文件
- 图片最大 20MB，视频和其他文件最大 100MB
- 附件查看改为页内弹层，减少 Safari / 主屏幕 Web App 跳页干扰
- 电脑版控制面板新增“网站入口”二次选择面板：扫码、复制链接、打开网页都在一个入口里
- 新增守护模式：可立即启动，也可空闲自动启动；默认保持亮屏，并显示当前工作状态
- 修复部分场景下 Pro 状态刷新不及时的问题
