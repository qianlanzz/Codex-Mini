...
- 版本：Codex Mini v4.1.0
- 安装包：[直接下载 Codex Mini v4.1.0.dmg](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v4.1.0/Codex.Mini.v4.1.0.dmg)
- Release 页面：[codex-mini-v4.1.0](https://github.com/CoimgRain/Codex-Mini/releases/tag/codex-mini-v4.1.0)
...
1. 在 Releases 页面下载带版本号的 `Codex.Mini.v4.1.0.dmg`
